...
Rectangle {
    ...
    // mapa. No se recalcula —seria inutil— pero la ruta sigue siendo valida, asi
    // que las indicaciones se mantienen y el aviso va aparte.
            ...
            Row {
                ...
                Column {
                    ...
                    Label {
                        ...
                        font.pixelSize: ts(1.63); font.bold: true
